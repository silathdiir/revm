...
## [14.2.0](https://github.com/silathdiir/revm/compare/op-revm-v14.1.0...op-revm-v14.2.0) - 2026-01-06

### Added

- BAL EIP-7928 ([#3070](https://github.com/silathdiir/revm/pull/3070))
- early return if the l1 fee scalar is zero ([#3213](https://github.com/silathdiir/revm/pull/3213))
...
- Remove redundant tx fetch in Optimism handler gas accounting ([#3220](https://github.com/silathdiir/revm/pull/3220))
